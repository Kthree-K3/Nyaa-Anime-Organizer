// ================= تنظیمات اصلی ==================
const MY_WORKER_URL = "https://nyaa.khalilkhko.of.to";
...
async function searchAniListForAdd(query) {
    ...
    try {
        ...
        json.data.Page.media.forEach(anime => {
            ...
            div.innerHTML = `
                <img src="${anime.coverImage.medium.replace('https://s4.anilist.co/', 'https://img-anilist.khalilkhko.of.to/api/image?path=')}" class="add-item-img">
            ...
            div.onclick = () => {
                addToMyList({
                    ...
                    cover: anime.coverImage.medium.replace('https://s4.anilist.co/', 'https://img-anilist.khalilkhko.of.to/api/image?path=')
                });
                myListSearchInput.value = '';
                myListSearchResults.style.display = 'none';
    ...
    try {
        ...
        while (keepScanning && isScanning) {
            ...
            try {
                ...
                const ONALRIE_WORKER_URL = "https://onalrie.khalilkhko.of.to";
...
window.showAniListDetails = function(index) {
    ...
    const img = anime.coverImage.large.replace('https://s4.anilist.co/', 'https://img-anilist.khalilkhko.of.to/api/image?path=');
    
    const bannerStyle = anime.bannerImage 
        ? `background-image: url('${anime.bannerImage.replace('https://s4.anilist.co/', 'https://img-anilist.khalilkhko.of.to/api/image?path=')}');` 
